    ...
    <div id = "ImageRegister">
        <div class="row">
            ...
            <div class="col-md-6 mb-4">
                ...
                <div class="form-outline">
                    ...
                    <input type="text" class="form-control form-control-lg" v-model="form.values.lname" id="lname" @blur="validate('lname')"/>
        ...
        <div class="row">
            <div class="col-md-6 mb-4">
                ...
                <div class="form-outline">
                    <input type="email" id="emailAddress" class="form-control form-control-lg"  v-model="form.values.emailR"  aria-describedby="emailHelp" @blur="validate('emailR')"/>
        ...
        <div class="row">
            <div class="col-md-6 mb-4 pb-2">
                <div class="form-outline">
                    <input type="password" id="passwordRegister" class="form-control form-control-lg"  v-model="form.values.passwordR"  @blur="validate('passwordR')"/>
        ...
        <div class="row">
            <div class="col-md-6 mb-4 pb-2">
                <div class="form-outline ">
                    <input type="date" class="form-control form-control-lg" id="birthdayDate" v-model="form.values.dateOfBirth" @blur="validate('dateOfBirth')"/>
        ...
        <div class="row">
            <div class="col-md-12 mb-4 pb-2">
                <div class="form-outline">
                    <input type="file"  class="form-control form-control-lg"  v-on:change="form.values.profilePicture" placeholder="Photo" s capture @blur="validate('profilePicture')"/>
